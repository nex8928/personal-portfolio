...
const RagVisualizer: React.FC = () => {
  ...
  return (
    <div className="glass-panel" style={{ width: '100%', maxWidth: '550px', height: '470px', minHeight: '470px', maxHeight: '470px', padding: '20px 24px', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '12px', position: 'relative', boxSizing: 'border-box' }}>
